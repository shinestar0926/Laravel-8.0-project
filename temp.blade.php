...
<style>
  ...
  #select2-select2-icons-container {
    padding-left:22px !important;
  }
  .feather {
  ...
  .content.app-content {
    /* padding: calc(2rem + 4.45rem) 2rem 0 !important; */
    top:90px;
  }
  .buy-now {
...
<!-- 20210507 Toolbar Modal -->

<!-- <div class="modal-size-default d-inline-block">

  <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#defaultSize" style="width:50%">
    <i data-feather='tool' class="action_tag"></i><h3>Tools</h3>
  </button>
 
  <i data-feather='save' class="action_tag"></i>
  <i data-feather='download' class="action_tag"></i>
  ...
  <!-- <div class="d-flex justify-content-between">
    <button class="btn btn-outline-secondary btn-prev" >
      ...
      <span class="align-middle d-sm-inline-block d-none">Tools</span>
