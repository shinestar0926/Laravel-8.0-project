...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function eventClick(info) {
    eventToUpdate = info.event._def;
    console.log('event click', eventToUpdate)
    ...
    updateEventBtn.on('click', function () {
      if (eventForm.valid()) {
        console.log("dsssssssssssss", eventToUpdate);
        var eventData = {
          id: eventToUpdate.publicId,
    ...
    btnDeleteEvent.on('click', function () {
      removeEvent(eventToUpdate.publicId);
      sidebar.modal('hide');
...
/* 20210507 */
  // $(".content.app-content").css('padding' , 'calc(2rem + 4.45rem) 2rem 0');
  $(".content.app-content").css('padding' , '0 2rem 0');
  var calendarMarginBottom = parseInt($(".app-calendar").css('margin-bottom'));
  var calendarPTop = parseInt($(".card-body.pb-0").css('padding-top'));
  var aroundHeight = $(".header-navbar-shadow").outerHeight() +  calendarMarginBottom + 'px';
  // + $(".content-header.row").outerHeight() + calendarMarginBottom + calendarPTop + $(".footer.footer-light").outerHeight() + 'px'
  var scrollbarWide = getScrollbarWidth();
  $(".content-header.row").css('display' , 'none');
  $(".footer.footer-light").css('display' , 'none');
  let resourceId;
  var calendar = new FullCalendar.Calendar(calendarEl, {
    // height: `calc(100vh - ${aroundHeight})`,
    height: '100%',
    // width: `calc(100vw - ${scrollbarWide})`,
    expandRows: true, //20210506
    timeZone: 'UTC',
  ...
  console.log(new FullCalendar.Calendar);
  // Render calendar
  ...
  function addEvent(eventData) {
    ...
    console.log('event resources', calendar.getEventSources())
  ...
  $(addEventBtn).on('click', function () {
    if (eventForm.valid()) {
      console.log("oadsjf", eventTitle.val())
      var newEvent = {
...
20210507
*/
$(".fc-toolbar-chunk").first().find('h2').css('display' , 'none');
$(".fc-toolbar-chunk").eq(1).find('h2').css('display' , 'inline-block');
// console.log($("#toolbar_menu").html());
